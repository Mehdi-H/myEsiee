...
# @Last Modified time: 2015-05-29 17:17:44
...
def init_selenium_browser(urlAurion = "https://aurionprd.esiee.fr"):
	print("script_aurion::config_selenium::init_selenium_browser()")

	# Config webbrowser
	print("Configuration de selenium avec PhantomJS")

	driver = mypkg.getOrCreateWebdriver()

	print("Navigateur configure")
