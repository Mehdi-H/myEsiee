...
public class BaseDrawerActivity extends ActionBarActivity
    ...
    protected NavigationDrawerFragment onCreateDrawer() {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_base_drawer, container, false);
            return rootView;
        }
        ...
        public void onAttach(Activity activity) {
            ...
            ((BaseDrawerActivity) activity).onSectionAttached(
