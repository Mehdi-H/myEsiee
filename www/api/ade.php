<?php
			...
			&& isset($_GET['heure']))
		{
			...
			echo("<p>Spécifiez la ressource (genre 659 pour la salle 5201V...), la date (format jj/mm/aaaa) et l'heure à vérifier (format hh:mm)</p>");
			echo("<p>Exemple : <pre>http://seevendev.alwaysdata.net/eroom_/ade.php?resource=659&date=05/05/2015&heure=09:00</pre> (la salle est occupée)</p>");
			echo("<p>Exemple : <pre>http://seevendev.alwaysdata.net/eroom_/ade.php?resource=659&date=05/05/2015&heure=13:30</pre> (la salle est libre)</p>");
			exit;
		}
 ?>
