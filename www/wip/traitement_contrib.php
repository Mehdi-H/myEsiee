...
<html>
	...
	<body>
		...
		?>
			<p>
			Liste des contributions : <br />
			IdContribution : <?php echo $donnees['idcontribution']; ?> <br />
			Login : <?php echo $donnees['login']; ?> <br />
			Type contribution : <?php echo $donnees['type_contribution']; ?> <br />
			Date contribution : <?php echo $donnees['date_contribution']; ?> <br />
			Navigateur : <?php echo $donnees['navigateur']; ?> <br />
			Version Android : <?php echo $donnees['version_android']; ?> <br />
			Email : <?php echo $donnees['email']; ?> <br />
			Location : <?php echo $donnees['location']; ?> <br />
